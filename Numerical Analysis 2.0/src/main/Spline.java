...
public class Spline {
	...
	public void makeAndShow(double value) {
		for (int i = 0; i < x.length - 1; i++) {
			...
			System.out.printf("A0 = %.8f | ", round(spline[0]));
			System.out.printf("A1 = %.8f | ", round(spline[1]));
			System.out.printf("A2 = %.8f | ", round(spline[2]));
			System.out.printf("A3 = %.8f", round(spline[3]));
			System.out.println();
